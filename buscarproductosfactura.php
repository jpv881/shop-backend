<?php
   ...
   include('conexion.php');
    ...
    $sql = 'SELECT * FROM producto WHERE producto.activo and producto.nombre like "%'.$str.'%" or producto.precio like "%'.$str.'%" or producto.tipo = (select tipo.codigo from tipo where tipo.nombre like "%'.$str.'%")';
