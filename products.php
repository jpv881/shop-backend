...
<div class="main">
	...
	<div class="top_main">
		<a href="allproducts.php">show all</a>
		<div class="clear"></div>
	</div>
   ...
   include('conexion.php');
    ...
    while($fila = mysqli_fetch_array($consulta)){ ?>
		<h2 class="style"><?php echo $fila['nombre']; ?></h2>
		<div class="grids_of_3">
		<?php
			$sqlProductos = "select * from producto where tipo =".$fila['codigo']." limit 3";	
			$consultaProductos = mysqli_query($conexion, $sqlProductos);
			while($filaProductos = mysqli_fetch_array($consultaProductos)){ ?>
			<div class="grid1_of_3">
				<a href="#">
					<img src="<?php echo $filaProductos['rutaimagen']; ?>" alt="">
					<h3><?php echo $filaProductos['nombre']; ?></h3>
					<span class="price">$<?php echo $filaProductos['precio']; ?></span>
				</a>
			</div>
